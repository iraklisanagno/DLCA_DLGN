...
This repo contains the collection of papers and repos regarding Differentiable Logic Gate Networks (DLGNs)
...
- [Differentiable Logic Cellular Automata](https://google-research.github.io/self-organising-systems/difflogic-ca/) --> [DLCA](./DLCA/)
...
- [A Method for Optimizing Connections in Differentiable Logic Gate Networks](https://arxiv.org/pdf/2507.06173)
- [Learning Interpretable Differentiable](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=10681646)
- [A Scalable, Interpretable, Verifiable & Differentiable Logic Gate Convolutional Neural Network Architecture From Truth Tables](https://arxiv.org/pdf/2208.08609)
