#!/usr/bin/env python3
"""Evaluate frozen CIFAR-10 S comparator checkpoints exactly once."""
...
SUMMARY_PATH = ROOT / "summary" / "table2_s_comparator_final.json"
LOG_DIR = ROOT / "logs" / "table2_s_comparator_final" / "test"
...
def main() -> int:
    ...
    payload = {
        "cell": "table2_cifar10_s_comparators",
