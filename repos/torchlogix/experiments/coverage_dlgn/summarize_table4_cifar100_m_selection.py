#!/usr/bin/env python3
"""Audit the paired three-seed CIFAR-100 M 20K selection."""
...
QUEUE_SUMMARY = (
    ROOT / "logs" / "table4_cifar100_m_selection" / "queue_summary.json"
)
JSON_PATH = ROOT / "summary" / "table4_cifar100_m_selection.json"
CSV_PATH = ROOT / "summary" / "table4_cifar100_m_selection.csv"
...
def main() -> None:
    ...
    if audit["failed"]:
        raise RuntimeError(f"CIFAR-100 M selection failed: {audit['failed']}")
