...
\end{tikzpicture}
\caption{One offline construction, two architecture adapters. Semantic pairing defines the input graph; matching stages organize deeper predecessors. Convolution retains the existing spatial sampler and shared logic trees. Construction metadata is discarded before deployment.}
\label{fig:overview}
\end{figure*}
