# Current claims and budgets

The current anchor is [paper_story.md](../paper_story.md), created before the 2026-09-15 rewrite. It replaces the initial plan, preserved in output/revisions/before_story_20260915/notes/.

The title is **LogicConnect: Structured Connectivity Design for Differentiable Logic Gate Networks**. LogicConnect denotes the unified construction. LogicConnect-D is the separate dense specialization shown in comparative results; U2/V3 remain internal provenance identifiers.
