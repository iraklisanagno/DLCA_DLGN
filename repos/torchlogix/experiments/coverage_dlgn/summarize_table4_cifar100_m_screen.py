#!/usr/bin/env python3
"""Audit and summarize the diagnostic dense CIFAR-100 M screen."""
...
QUEUE_SUMMARY = (
    ROOT / "logs" / "table4_cifar100_m_screen" / "queue_summary.json"
)
JSON_PATH = ROOT / "summary" / "table4_cifar100_m_screen.json"
CSV_PATH = ROOT / "summary" / "table4_cifar100_m_screen.csv"
...
def main() -> None:
    ...
    if audit["failed"]:
        raise RuntimeError(f"CIFAR-100 M screen failed: {audit['failed']}")
    ...
    payload = {
        "phase": queue["phase"],
        "provenance": "TRIED",
        "protocol_deviation": "diagnostic screen after S failed promotion",
