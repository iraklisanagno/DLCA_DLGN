# CoverageDLGN — DATE presentation evidence, September 6, 2026
...
- **OUR:** CoverageDLGN or our ablation; **REP:** locally reproduced baseline; **ADAPT:** adapted external method; **NEG:** unsuccessful local reproduction.
...
| Dataset | Method / provenance | Layers | Rank | T accuracy | Seeds | Trainable parameters | Time, min | GPU, GiB |
|---|---|---:|---:|---:|---:|---:|---:|---:|
| MNIST | Random — REP | 6 | 2 | 97.090 ± 0.180 | 5 | 0.768M | 15.03 | 0.099 |
| MNIST | **V3 — OUR** | 6 | 2 | **97.500 ± 0.099** | 5 | **0.768M** | **15.02** | **0.099** |
| MNIST | Mommen — ADAPT | 2 | 2 | 98.084 ± 0.066 | 5 | 2.304M | 35.92 | 1.002 |
| MNIST | LILogicNet — ADAPT | 3 | 2 | 98.124 ± 0.029 | 5 | 3.840M | 82.02 | 4.187 |
| MNIST | BitLogic — ADAPT | 2 | 4 | **98.204 ± 0.042** | 5 | 3.840M | 89.18 | 3.557 |
| Fashion | Random — REP | 6 | 2 | 86.308 ± 0.186 | 5 | 0.768M | 14.97 | 0.099 |
| Fashion | **V3 — OUR** | 6 | 2 | **87.102 ± 0.357** | 5 | **0.768M** | **15.02** | **0.099** |
| Fashion | Mommen — ADAPT | 3 | 2 | 87.260 ± 0.282 | 3 | 1.536M | 24.04 | 0.498 |
| Fashion | LILogicNet — ADAPT | 2 | 2 | 88.437 ± 0.159 | 3 | 3.840M | 70.84 | 4.676 |
| Fashion | BitLogic — ADAPT | 2 | 4 | **89.740 ± 0.243** | 3 | 3.840M | 88.94 | 3.557 |
...
All methods use **6 × 8K gates**, with the same 200-epoch effort. These are **validation results**. BitLogic still changes fan-in and input encoding.
...
| Dataset / architecture | Gates | Random T | V3 T | U2 T | U2−random, pp | Paired 95% CI |
|---|---:|---:|---:|---:|---:|---:|
| MNIST, six layers | 8K | 91.273 ± 0.217 | 91.907 ± 0.307 | **91.937 ± 0.137** | **+0.663** | [0.015, 1.311] |
| Fashion, six layers | 16K | 85.197 ± 0.261 | **85.913 ± 0.356** | 85.717 ± 0.453 | +0.520 | [−1.016, 2.056] |
| CIFAR-10 S | 48K | 48.913 ± 0.346 | **52.390 ± 0.295** | 52.097 ± 0.630 | **+3.183** | [0.772, 5.595] |
| CIFAR-10 M | 512K | 54.097 ± 0.171 | 58.357 ± 0.253 | **58.653 ± 0.168** | **+4.557** | [3.781, 5.332] |
| CIFAR-10 L | 1.28M | 55.870 ± 0.308 | **61.073 ± 0.463** | 60.463 ± 0.348 | **+4.593** | [3.721, 5.466] |
...
| Architecture | Gates | Seeds | Random T | V3 T | Gain, pp | Paired 95% CI | Random / V3 min | GPU, GiB, both |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 4 × 12K | 48K | 5 | 49.056 ± 0.356 | **52.358 ± 0.282** | +3.302 | [2.767, 3.837] | 12.24 / 12.26 | 0.106 |
...
| 4 × 128K | 512K | 5 | 54.028 ± 0.160 | **58.284 ± 0.259** | +4.256 | [3.851, 4.661] | 41.55 / 41.48 | 1.123 |
| 5 × 256K | 1.28M | 5 | 55.960 ± 0.251 | **61.020 ± 0.336** | +5.060 | [4.555, 5.565] | 113.47 / 113.22 | 2.717 |

**Presentation message:** every evaluated fixed-budget CIFAR-10 frontier point improves, with positive paired confidence intervals.
...
| Protocol | Method / provenance | Gates | Seeds | T accuracy | Total / routing parameters | Time, min | GPU, GiB |
|---|---|---:|---:|---:|---:|---:|---:|
| Standard dense S | Mommen — ADAPT | 48K | 3 | 50.950 ± 0.244 | 1.536M / 0.768M | 26.45 | 0.480 |
| Standard dense S | LILogicNet — ADAPT | 48K | 3 | 50.743 ± 0.574 | 3.840M / 3.072M | 86.87 | 3.949 |
...
| LILogic M, 1 × 64K | Random — REP | 64K | 3 | 49.010 ± 0.426 | 1.024M / 0 | 14.62 | 0.474 |
| LILogic M, 1 × 64K | **U2 — OUR** | 64K | 3 | **52.543 ± 0.296** | **1.024M / 0** | **14.59** | **0.474** |
| LILogic M, 1 × 64K | Top-32 — REP | 64K | 1 | **57.840** | 5.120M / 4.096M | 37.81 | 8.100 |
| LILogic L, 2 × 128K | Random — REP | 256K | 3 | 55.333 ± 0.469 | 4.096M / 0 | 15.20 | 1.557 |
| LILogic L, 2 × 128K | **U2 — OUR** | 256K | 3 | **60.193 ± 0.286** | **4.096M / 0** | **18.47** | **1.557** |
| LILogic L, 2 × 128K | Top-32 — REP | 256K | 1 | **62.030** | 20.480M / 16.384M | 350.64 | 24.861 |
...
These resource ratios are descriptive; Top-32 has one local seed.
...
| Gates | Method | Rank | T accuracy | Training parameters | Time, min | GPU, GiB |
|---|---|---:|---:|---:|---:|---:|
| 8K | Random | 2 | 26.175 ± 0.445 | 0.128M | 8.50 | 0.028 |
| 8K | U2 | 2 | **28.435 ± 1.648** | 0.128M | 8.47 | 0.028 |
| 8K | Learned-16 | 4 | 27.500 ± 0.113 | 0.640M | 9.92 | 0.611 |
| 32K | Random | 2 | 25.945 ± 0.870 | 0.512M | 8.58 | 0.104 |
| 32K | U2 | 2 | 26.040 ± 0.014 | 0.512M | 8.64 | 0.104 |
| 32K | Learned-16 | 4 | 16.625 ± 0.078 | 2.560M | 41.21 | 2.372 |
| 128K | Random | 2 | 25.160 ± 0.156 | 2.048M | 8.52 | 0.414 |
| 128K | U2 | 2 | 25.930 ± 2.871 | 2.048M | 8.56 | 0.414 |
| 128K | Learned-16 | 4 | 13.160 ± 0.240 | 10.240M | 164.47 | 9.456 |
...
| Architecture | Updates | Method | V accuracy | T accuracy | T gain over random | Time, h | GPU, GiB |
|---|---:|---|---:|---:|---:|---:|---:|
| LogicTreeNet-S | 350K | Random | 58.680 | 57.370 | — | 4.975 | 1.831 |
...
| LogicTreeNet-M | 200K | Random | 70.680 | 69.570 | — | 25.47 | 14.615 |
...
All accuracies are **V, three seeds**. Raw random — REP; raw U2 — OUR; WARP arms — ADAPT.
...
| Architecture | Gates | Scope / seeds | Random | V3 or stated variant | Gain | Random / variant min | GPU, GiB |
|---|---:|---|---:|---:|---:|---:|---:|
| 2 × 4K | 8K | V, 20K / 3 | 8.780 ± 0.381 | V3: 7.940 ± 0.302 | −0.840 pp | — | — |
| 2 × 16K | 32K | V, 20K / 3 | 10.060 ± 0.220 | V3: 9.707 ± 0.076 | −0.353 pp | — | — |
...
| 6 × 64K | 384K | T / 3 | 20.677 ± 0.522 | V3: 21.010 ± 0.131 | +0.333 pp | 11.37 / 11.49 | 0.795 |
...
| 6 × 256K | 1.536M | V, 5K screen / 1 | 11.680 | Best screened V3: 11.060 | −0.620 pp | 32.03 / 31.59 | 14.181 |
...
| Protocol | Method / provenance | Scope / seeds | Accuracy | Time | GPU, GiB |
|---|---|---|---:|---:|---:|
| Legacy conv S, 20K | Random — REP | T / 3 | 55.420 | — | — |
| Legacy conv S, 20K | V4 — OUR | T / 3 | **57.420** | — | — |
| WARP-style legacy M, 30K | Matched random, uniform thresholds — REP | V / 1 | 64.580 | 3.87 h | 14.614 |
| WARP-style legacy M, 30K | V4, uniform thresholds — OUR | V / 1 | **66.230** | 3.85 h | 14.614 |
| WARP-style legacy M, 30K | Learnable thresholds — ADAPT | V / 1 | 65.880 | 4.29 h | 14.619 |
