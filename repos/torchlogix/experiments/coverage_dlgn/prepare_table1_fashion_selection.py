#!/usr/bin/env python3
"""Generate the locked three-seed, 20K Fashion-MNIST selection queue."""
...
SUMMARY_PATH = ROOT / "summary" / "table1_fashion_screen.json"
CONFIG_DIR = ROOT / "configs" / "table1_select_fashion"
QUEUE_PATH = ROOT / "queues" / "table1_select_fashion.json"
SCREEN_CONFIG_DIR = ROOT / "configs" / "table1_screen_fashion"
